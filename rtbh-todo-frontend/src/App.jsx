    ...
    return (
        <div className='flex flex-col h-screen'>
            ...
            <main className='grid grid-cols-8 bg-slate-300 grow'>
                <section
                    id='tasks'
                    className='col-start-2 col-span-6 md:col-span-4 md:col-start-3 lg:col-span-2 lg:col-start-4 bg-white p-[.8rem] my-[2.4rem] md:mt-[3.2rem] md:p-[1.6rem] rounded-2xl h-fit'>
